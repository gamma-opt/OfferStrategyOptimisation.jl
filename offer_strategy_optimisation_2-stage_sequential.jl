...
fixed_v = file["v"]
optimal_FCRD_bids = [fixed_v[j,t][1] for j in J, t in T]

@constraint(model, fix_DA_strategy, x .== optimal_DA_bids)

@constraint(model, fix_FCRD_strategy, v .== optimal_FCRD_bids)
